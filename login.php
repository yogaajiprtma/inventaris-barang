...
if (isset($_POST['username_login'])) {
  ...
  if (empty($username_login) || empty($password_login)) {
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM user WHERE username='$username_login' AND password='$password_login'");
                  ...
                  <form class="row g-3 needs-validation" method="post" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" name="username_login" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-11">
                      ...
                      <input type="password" name="password_login" id="password" class="form-control" id="yourPassword" required>
